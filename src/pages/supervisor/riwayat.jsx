...
const RiwayatSV = () => {
  ...
  return (
    <div className="ml-72 pr-14 p-1 mt-[-12px]
     bg-white font-sans min-h-screen relative overflow-hidden">
      <h1 className="font-bold text-2xl mb-3">Riwayat Reimbursement</h1>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-6 py-3">Instansi</th>
              <th scope="col" className="px-6 py-3">Departement</th>
              <th scope="col" className="px-6 py-3">Tgl Pengajuan</th>
              <th scope="col" className="px-6 py-3">Harga Reimburst</th>
          ...
          <tbody>
            {filteredItems.map((item) => (
              <tr
                ...
                onClick={() => navigate('/supervisor/detailriwayat')}
              >
