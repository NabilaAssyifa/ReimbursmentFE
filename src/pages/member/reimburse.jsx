...
const ReimburseMember = () => {
  ...
  return (
      <div className="ml-72 pr-14 mt-[-12px] p-1 bg-white font-sans min-h-screen relative overflow-hidden">
      ...
      <div className="w-full flex justify-end"> 
        <button
          type="button"
          className="h-10 mt-[-60px] w-42 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
          onClick={toggleModal}
        >
