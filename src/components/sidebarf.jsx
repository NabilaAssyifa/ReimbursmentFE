            ...
            >
                ...
                <ul className="mt-2">
                    <li className="py-2">
                        <a
                            ...
                            className={"flex items-center text-white font-sans hover:bg-neutral-700 transition-all duration-200 h-10 w-full "+(location.pathname==='/finance/dashboard'?'border-l-4 border-white':'')}
                ...
                <ul className="mt-2">
                    <li className="py-2">
                        <a
                            ...
                            className={"flex items-center text-white font-sans hover:bg-neutral-700 transition-all duration-200 h-10 w-full "+(location.pathname==='/finance/project'?'border-l-4 border-white':'')}
                            style={{ fontFamily: 'Poppins, sans-serif' }}
                        >
                ...
                <ul className="mt-2">
                    <li className="py-2">
                        <a
                            ...
                            className={"flex items-center text-white font-sans hover:bg-neutral-700 transition-all duration-200 h-10 w-full "+(location.pathname==='/finance/reimburse'?'border-l-4 border-white':'')}
                            style={{ fontFamily: 'Poppins, sans-serif' }}
                        >
                ...
                <ul className="mt-2">
                    <li className="py-2">
                        <a
                            href="/finance/verif"
                            className={"flex items-center text-white font-sans hover:bg-neutral-700 transition-all duration-200 h-10 w-full "+(location.pathname==='/finance/verif'?'border-l-4 border-white':'')}
                            style={{ fontFamily: 'Poppins, sans-serif' }}
                        >
                ...
                <ul className="mt-2">
                    <li className="py-2">
                        <a
                            href="/finance/riwayat"
                            className={"flex items-center text-white font-sans hover:bg-neutral-700 transition-all duration-200 h-10 w-full "+(location.pathname==='/finance/riwayat'?'border-l-4 border-white':'')}
                            style={{ fontFamily: 'Poppins, sans-serif' }}
                        >
